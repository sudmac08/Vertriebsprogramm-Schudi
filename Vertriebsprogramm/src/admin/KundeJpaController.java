...
public class KundeJpaController implements Serializable
{
    ...
    public void create(Kunde kunde) throws PreexistingEntityException, Exception
    {
        ...
        {
            if (findKunde(kunde.getKundeid()) != null)
            {
                throw new PreexistingEntityException("Kunde " + kunde + " already exists.", ex);
            }
            throw ex;
        } finally
        {
