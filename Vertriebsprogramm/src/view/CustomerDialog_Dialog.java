 ...
 * @author Mike
 */
public class CustomerDialog_Dialog extends javax.swing.JDialog {

    /** Creates new form CustomerDialog_Dialog */
    public CustomerDialog_Dialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CustomerDialog_Dialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                CustomerDialog_Dialog dialog = new CustomerDialog_Dialog(new javax.swing.JFrame(), true);
